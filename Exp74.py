...
It uses prevalent, full-ventricle and concatenated dataset.
"""
import argparse
...
if __name__ == "__main__":
    ...
    parser.add_argument('--code', type=int, default=7416)
    parser.add_argument('--dpr', type=float, default=0.75)
